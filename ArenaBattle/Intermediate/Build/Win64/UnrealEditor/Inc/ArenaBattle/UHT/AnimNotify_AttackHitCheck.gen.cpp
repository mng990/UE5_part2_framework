...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAnimNotify_AttackHitCheck_Statics::ClassParams = {
		...
		0,
		0x001120A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAnimNotify_AttackHitCheck_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotify_AttackHitCheck_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ArenaBattle_Source_ArenaBattle_Animation_AnimNotify_AttackHitCheck_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimNotify_AttackHitCheck, UAnimNotify_AttackHitCheck::StaticClass, TEXT("UAnimNotify_AttackHitCheck"), &Z_Registration_Info_UClass_UAnimNotify_AttackHitCheck, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimNotify_AttackHitCheck), 3039979546U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ArenaBattle_Source_ArenaBattle_Animation_AnimNotify_AttackHitCheck_h_231131629(TEXT("/Script/ArenaBattle"),
