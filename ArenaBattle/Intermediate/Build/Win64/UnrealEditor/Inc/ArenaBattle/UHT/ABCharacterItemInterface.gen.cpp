...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UABCharacterItemInterface_Statics::ClassParams = {
		...
		0,
		0x000840A1u,
		METADATA_PARAMS(Z_Construct_UClass_UABCharacterItemInterface_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UABCharacterItemInterface_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ArenaBattle_Source_ArenaBattle_Interface_ABCharacterItemInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UABCharacterItemInterface, UABCharacterItemInterface::StaticClass, TEXT("UABCharacterItemInterface"), &Z_Registration_Info_UClass_UABCharacterItemInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UABCharacterItemInterface), 216376252U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ArenaBattle_Source_ArenaBattle_Interface_ABCharacterItemInterface_h_3911056353(TEXT("/Script/ArenaBattle"),
